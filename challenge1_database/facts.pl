...
computingPlatform(Trademark, Name, SerialNumber, YearOfAcquisition, RAMCapacity_GB,
         ...
         TypeOfComputer, GPUManufacturer, VRAM_GB).
*/

% Available HP computing platforms
computingPlatform('HP', 'Omen Max 16', 'AH0007NS', 2025, 64, intel, 24, 4000, laptop, nvidia, 24).
...
computingPlatform('HP', 'Omen 16',     'Wf0083DX', 2024, 16, intel, 24, 1000, laptop, nvidia, 8).
